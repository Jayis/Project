	...
	static
	{
		...
		action = new ProviderRegistrationAction()
		{
			public void register(Object obj)
				throws	Exception
				{
					MpegFormatConversionProvider provider = (MpegFormatConversionProvider) obj;
					TAudioConfig.addFormatConversionProvider(provider);
				}
		};
		registerClasses(MpegFormatConversionProvider.class, action);
		*/
					    ...
					    ProviderRegistrationAction action)
	{
		...
		if (providers != null)
		{
			...
			while (providers.hasNext())
			{
                ...
                if (TDebug.TraceInit){System.out.println(provider);}
				try
				{
