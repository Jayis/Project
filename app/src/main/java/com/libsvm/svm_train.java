...
public class svm_train {
	...
	private static void do_cross_validation()
	{
		int i;
		int total_correct = 0;
	...
	/**
	 * Main function to execute svm_train
	 * I just wrapped it and throw it into this package
	 * 
	 * */
	public static void goTrain(String argv[]) throws IOException
	{
		run(argv);
	}
	...
	private static void read_problem() throws IOException
	{
